...
<body>
    ...
    <header>
        ...
        <nav class="navbar">
            <ul>
                <li><a href="user_page.php">Tjedan igre</a></li>
    ...
    <div class="container">
        <div class="profile">
            ...
            <a class="btn" onclick="updateP()">Uredi profil</a>
        </div>
    </div>

    <div class="update-profile hide">
        <?php
            $query = "SELECT * FROM user WHERE id = '$userid'";
            $result = mysqli_query($conn, $query);
            if (mysqli_num_rows($result) > 0) {
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <a class="btn" style="background: red;" onclick="goBack()">Go back</a>
        </form> 
    </div>
    ...
    <script>
        ...
        function updateP(){
            ...
            updateProfile.classList.remove("hide");
            resetQuiz();
        }

        function goBack(){
            updateProfile.classList.add("hide");
